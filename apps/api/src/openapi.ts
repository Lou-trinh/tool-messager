...
export const openApiDocument = {
  ...
  paths: {
    ...
    '/platforms/zalo/webhook': { post: { tags: ['accounts'], summary: 'Verify, deduplicate and queue a Zalo OA webhook event', parameters: [{ name: 'x-zevent-signature', in: 'header', required: false, description: 'Required for events; omitted only by the Zalo reachability probe.', schema: { type: 'string' } }], responses: { 200: accepted, ...errorResponses } } },
