...
type SocialAccount = { id: string; displayName: string; platform: string; platformAccountId: string; status: string; lastErrorCode?: string; lastSyncAt?: string; workspace: { name: string; slug: string }; _count: { messages: number; campaigns: number; conversations: number; syncJobs: number } };
